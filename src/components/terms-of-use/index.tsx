  ...
  return (
    <View style={styles.content}>
      ...
      <Text style={styles.paragraph}>
        ...
        Service. Terms of Use Template for WhiteOf Corporation.
      </Text>
      <Text style={styles.strong}>Accounts</Text>
      <Text style={styles.paragraph}>
        When you create an account with us, you asked to provide us your name
        (or nickname) and phone number. This information can be used to restore
        you access to the Service and will not be provided to any third party.
      </Text>
      <Text style={styles.paragraph}>
        You also asked to create a passcode. You are responsible for
        safeguarding the passcode that you use to access the Service and for any
        activities or actions under your passcode, whether your passcode is with
      ...
      <Text style={styles.paragraph}>
        ...
        rights. Other product and WhiteOf Corporation names that are mentioned
      ...
      <Text style={styles.paragraph}>
        WhiteOf Corporation may assign or delegate these Terms of Service and/or
        WhiteOf Corporation’s Privacy Policy, in whole or in part, to any person
        ...
        Privacy Policy without WhiteOf Corporation’s prior written consent, and
